            ...
            <div class="position-center">
                <form role="form" action="{{URL::to('/updateproduct/'.$edit_value->category_id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{($edit_value->product_name)}}" class="form-control" id="exampleInputEmail1" placeholder="Product's Name" name="productname">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Category's Description</label>
                        <textarea value="{{($edit_value->product_desc)}}" rows="8" class="form-control" id="exampleInputPassword1" name="productdesc"></textarea>
                    </div>
