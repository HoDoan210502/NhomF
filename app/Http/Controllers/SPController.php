...
class SPController extends Controller
{
    ...
    {
        $this->AuthLogin();
        $all_sp = DB::table('tbl_sanpham')->join('tbl_product', 'tbl_sanpham.category_id', '=', 'tbl_product.category_id')->join('tbl_manu', 'tbl_sanpham.manu_id', '=', 'tbl_manu.manu_id')->orderBy('tbl_sanpham.product_id','desc')->paginate(3);
